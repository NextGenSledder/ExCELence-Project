...
public class AnimationReader {
   ...
   * @param <AnimationModel> The main cs3500.animator.model interface type describing animations
   */
  public static <AnimationModel> AnimationModel parseFile(Readable readable,
